...
?>server=<?=$rtmp_server?>&serverAMF=<?=$rtmp_amf?>&tokenKey=<?=$tokenKey?>&serverProxy=best&serverRTMFP=<?=$rtmfp_server?>&p2pGroup=VideoWhisper&enableRTMP=1&enableP2P=0&supportRTMP=1&supportP2P=0&alwaysRTMP=0&alwaysP2P=0&bufferLive=0.1&bufferFull=0.5&welcome=Welcome!&username=<?=$username?>&userType=0&overLogo=logo.png&overLink=http://www.videowhisper.com&msg=<?=$msg?>&visitor=1&loggedin=<?=$loggedin?>&showCredit=1&disconnectOnTimeout=1&statusInterval=10000&offlineMessage=Channel+Offline&loadstatus=1